    ...
    <?php foreach ($this->teachers as $teacher) { ?>
        ...
        <div class="member">
            ...
            <?php if ($this->acl('users', 'view')) { ?>
                <a href="<?php echo $this->url(array('user' => $teacher->url), 'users_user_view') ?>"><img class="photo" src="<?php echo $this->config->resources->frontController->baseUrl . '/media/users/thumbnail_small/' . $teacher->getAvatar() ?>" alt="<?php echo $teacher->getFullName() ?>" title="<?php echo $teacher->getFullName() ?>" /></a>
            <?php } else { ?>
                <img class="photo" src="<?php echo $this->config->resources->frontController->baseUrl . '/media/users/thumbnail_medium/' . $teacher->getAvatar() ?>" alt="<?php echo $teacher->getFullName() ?>" title="<?php echo $teacher->getFullName() ?>" />
            <?php } ?>
                <div class="body">
            <?php if ($this->subject->amModerator()) { ?>
