...
<object class="playerpreview" type="application/x-shockwave-flash" data="<?php echo $this->CONFIG->wwwroot ?>media/videos/flvplayer.swf" width="668" height="<?php echo intval(668 / $proportion) ?>">
