<h1>Editar usuario: <?php echo $this->user->label ?></h1>
...
<?php } ?>
    ...
    <p class="submit"><input type="submit" value="Actualizar usuario" /><input type="button" value="Cancelar" onclick="location.href='<?php echo $this->lastPage() ?>'" /></p>
</form>
