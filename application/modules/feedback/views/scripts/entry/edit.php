...
echo '<tr><td colspan="2"><textarea name="description" cols="50" rows="5">' . $this->entry->description . '</textarea></td></tr>';
...
echo '<tr><td>&nbsp;</td><td><input type="submit" value="Guardar sugerencia" /> <a href="' . $this->lastPage() . '">Cancelar</a></td></tr>';
echo '</table>';
echo '</form>';
echo '</center>';
