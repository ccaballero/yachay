...
echo '<table><tr>';
if (Yachay_Acl::hasPermission('modules', 'list')) {
    echo '<td>[<a href="' . $this->url(array(), 'modules_list') . '">Lista</a>]</td>';
}
if (Yachay_Acl::hasPermission('modules', 'new')) {
    echo '<td>[<a href="' . $this->url(array(), 'modules_new') . '">Nuevo</a>]</td>';
}
if (Yachay_Acl::hasPermission('modules', 'lock')) {
...
if (count($this->modules)) {
    ...
    foreach ($this->modules as $module) {
        ...
        if (Yachay_Acl::hasPermission('modules', 'view')) {
