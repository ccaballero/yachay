<h1>Modulo: <?php echo $this->module->label ?></h1>

<p>
    <span class="bold">Estado: </span><?php echo $this->status($this->module->status) ?><br />
    <span class="bold">Tipo: </span><?php echo $this->type($this->module->type) ?><br />
    <span class="bold">Descripción: </span>
    <?php echo $this->module->description ?>
</p>
