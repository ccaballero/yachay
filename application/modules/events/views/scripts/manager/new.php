...
echo '<tr><td><b>Duración :</b></td><td>' . $this->interval('duration', 'interval') . '</td></tr>';
...
echo '<tr><td><b>Etiquetas (**):</b></td><td><input name="tags" value="" maxlength="128" /></td></tr>';
echo '<tr><td colspan="2">(*) Campos obligatorios.</td></tr>';
echo '<tr><td colspan="2">(**) Las etiquetas deben separarse con comas.</td></tr>';
echo '<tr><td>&nbsp;</td><td><input type="submit" value="Publicar Evento" /> <a href="' . $this->lastPage() . '">Cancelar</a></td></tr>';
echo '</table>';
echo '</form>';
echo '</center>';
