...
<form method="post" action="<?php echo $this->url(array('resource' => $this->resource->ident), $this->route) ?>" accept-charset="utf-8">
    ...
    <div class="resource">
        <div class="avatar">
            <img src="<?php echo $this->CONFIG->wwwroot . 'media/users/thumbnail_small/' . $this->USER->getAvatar() ?>" alt="<?php echo $this->USER->getFullName() ?>" title="<?php echo $this->USER->getFullName() ?>" />
        </div>
