...
control de los factores criticos han sido analizados.

Este capitulo compendia el tiempo que se ha establecido para evaluación, ademas
de mostrar el conjunto de recomendaciones finales que se han planteado, a partir
de los resultados obtenidos.

\section{Indicadores de medición}

\section{Creación de analiticas}
