...
\dirtree{%
.1 /.
.2 apps \ldots{} \begin{minipage}[t]{8cm} Paquetes instalados en el sistema.\end{minipage}.
.3 \ldots{}.
.2 configs.
.3 application.ini \ldots{} \begin{minipage}[t]{8cm} Archivo base de configuración del sistema.\end{minipage}.
.3 local.ini \ldots{} \begin{minipage}[t]{8cm} Archivo especifico de configuración del sistema.\end{minipage}.
...
.3 upload \ldots{} \begin{minipage}[t]{8cm} Archivos subidos al servidor.\end{minipage}.
.2 library.
.3 Collections \ldots{} \begin{minipage}[t]{8cm} Librería de estructuras de datos.\end{minipage}.
.3 File \ldots{} \begin{minipage}[t]{8cm} Librería de funciones para manejo de CSV.\end{minipage}.
.3 Xcel \ldots{} \begin{minipage}[t]{8cm} Librería de funciones para manejo de formulas matemáticas.\end{minipage}.
.3 Yachay.
.4 Controller.
.5 Plugin.
.6 Format.php.
...
.3 media.
.3 templates \ldots{} \begin{minipage}[t]{8cm} Carpeta de recursos propios de una plantilla.\end{minipage}.
.4 \ldots{}.
.3 index.php.
.2 templates \ldots{} \begin{minipage}[t]{8cm} Plantillas propiamente dichas.\end{minipage}.
.3 \ldots{}.
}
