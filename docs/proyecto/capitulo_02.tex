...
Primero se tratará el concepto de \emph{aprendizaje}, veremos los avances
...
desarrollándose a partir de los descubrimientos realizados en los campos de la
...
El aprendizaje no es sólo “el tiempo de seguridad” en las escuelas y
encerrados, sino que se extiende a través de múltiples contextos, experiencias
e interacciones. Ya no es sólo un concepto aislado o individual, sino que es
...
habilidades de las partes interesadas clave, como sus compañeros, escuelas o posibles empleadores\cite{Santamaria}.
...
\item Construcción de  Comunidad.
\end{itemize}
...
indicar qué tan cerca está de completar una tarea de una empresa o de superar a
tal persona.
\item Algunos disponen de una moneda virtual.
\item Con sistemas para la concesión, regalos y posible intercambio de puntos
entre usuarios.
\item Posibilidad de intercambiar objetos y utensilios entre los usuarios. \item Posibilidad también de solucionar los problemas entre ellos con un buena
