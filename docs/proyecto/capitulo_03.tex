...
producto de sotware; para terminar con una descripción de las etapas
establecidas segun la planificación del proyecto.
...
sido clasificados segun el objetivo especifico del proyecto al cual estos
contribuyen.
...
construiran, remarcando su característica temporal. Como se verá posteriormente
...
específicos\footnote{Para una definicion exacta puede consultarse:
