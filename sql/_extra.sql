...
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 1 WHERE `ident` = 112; /* tags_list */
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 9 WHERE `ident` = 115; /* feedback_list */
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 8 WHERE `ident` = 120; /* templates_list */
/*====================================================================================================================*/
/*====================================================================================================================*/
