...
/*====================================================================================================================*/
(42, 1), (43, 1), (44, 1), (45, 1), (46, 1), (47, 1), (48, 1), (49, 1), (50, 1), (51, 1), (52, 1),
(42, 2), (43, 2), (44, 2), (45, 2), (46, 2), (47, 2), (48, 2), (49, 2), (50, 2), (51, 2), (52, 2),
...
(58, 4), (59, 4), (60, 4), (61, 4), (62, 4), (63, 4), (64, 4), (65, 4), (66, 4),
/*====================================================================================================================*/
...
(99, 2), (100, 2), (101, 2), (102, 2),
(99, 3), (100, 3), (101, 3), (102, 3),
(99, 4), (100, 4), (101, 4), (102, 4),
/*====================================================================================================================*/
...
UPDATE `page` SET `menutype` = 'menubar', `menuorder` = 3 WHERE `ident` = 21;
UPDATE `page` SET `menutype` = 'menubar', `menuorder` = 3 WHERE `ident` = 31;
UPDATE `page` SET `menutype` = 'menubar', `menuorder` = 4 WHERE `ident` = 37;
UPDATE `page` SET `menutype` = 'menubar', `menuorder` = 6 WHERE `ident` = 42;
UPDATE `page` SET `menutype` = 'menubar', `menuorder` = 5 WHERE `ident` = 53;
UPDATE `page` SET `menutype` = 'menubar', `menuorder` = 7 WHERE `ident` = 72;
...
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 7 WHERE `ident` = 83;
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 1 WHERE `ident` = 103;
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 9 WHERE `ident` = 106;
UPDATE `page` SET `menutype` = 'footer', `menuorder` = 8 WHERE `ident` = 111;
/*====================================================================================================================*/
/*====================================================================================================================*/
