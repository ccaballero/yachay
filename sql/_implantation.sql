...
INSERT INTO `user`
(`role`, `label`,       `url`,         `password`,  `tsregister`,     `status`,   `surname`,          `name`,        `code`,    `email`,          `activity`, `sociability`)
VALUES
(6,      'antonio',     'antonio',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Mamani',           'Antonio',     200212474, 'id02@gmail.com', 5,           4), /*  2 */
(6,      'carlos',      'carlos',      md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Caballero',        'Carlos',      200323785, 'id03@gmail.com', 2,          11), /*  3 */
(5,      'leticia',     'leticia',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Blanco',           'Leticia',     200437576, 'id04@gmail.com', 2,           4), /*  4 */
(5,      'ruperto',     'ruperto',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Leon',             'Ruperto',     200175667, 'id05@gmail.com', 0,           1), /*  5 */
(5,      'johnny',      'johnny',      md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Arias',            'Jhonny',      200257678, 'id06@gmail.com', 0,           2), /*  6 */
(5,      'americo',     'americo',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Vargas',           'Americo',     200346789, 'id07@gmail.com', 0,           0), /*  7 */
(5,      'indira',      'indira',      md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Camacho',          'Indira',      200437870, 'id08@gmail.com', 2,           0), /*  8 */
(5,      'carrasco',    'carrasco',    md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Carrasco',         'Alvaro',      200529877, 'id09@gmail.com', 0,           0), /*  9 */
(4,      'viviana',     'viviana',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Morales',          'Viviana',     200687577, 'id10@gmail.com', 1,           0), /* 10 */
(4,      'juanpa',      'juanpa',      md5('asdf'), UNIX_TIMESTAMP(), 'inactive', 'Ruiz',             'Juan Pablo',  200776154, 'id11@gmail.com', 7,           0), /* 11 */
(4,      'christian',   'christian',   md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Mamani',           'Christian',   200865043, 'id12@gmail.com', 0,           0), /* 12 */
(4,      'wilfredo',    'wilfredo',    md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Vargas',           'Wilfredo',    200954932, 'id13@gmail.com', 0,           0), /* 13 */
(3,      'luis',        'luis',        md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Arce',             'Luis',        200048321, 'id14@gmail.com', 1,           0), /* 14 */
(3,      'pedro',       'pedro',       md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Valdes',           'Pedro',       200636211, 'id15@gmail.com', 2,           0), /* 15 */
(3,      'juan',        'juan',        md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Gomez',            'Juan',        200424121, 'id16@gmail.com', 5,           0), /* 16 */
(3,      'benjamin',    'benjamin',    md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Perez',            'Benjamin',    200213212, 'id17@gmail.com', 2,           0), /* 17 */
(3,      'juanjo',      'juanjo',      md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Olivera',          'Juan Jose',   200237323, 'id18@gmail.com', 4,           0), /* 18 */
(3,      'tatiana',     'tatiana',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Moruno',           'Tatiana',     200430434, 'id19@gmail.com', 1,           0), /* 19 */
(3,      'pablo',       'pablo',       md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Hurtado',          'Pablo',       200449545, 'id20@gmail.com', 4,           0), /* 20 */
(3,      'vladimir',    'vladimir',    md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Garcia',           'Vladimir',    200558656, 'id21@gmail.com', 2,           0), /* 21 */
(3,      'marcelo',     'marcelo',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Pavon',            'Marcelo',     200667667, 'id22@gmail.com', 1,           0), /* 22 */
(3,      'jorge',       'jorge',       md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Alameda',          'Jorge',       200788578, 'id23@gmail.com', 5,           0), /* 23 */
(3,      'eduardo',     'eduardo',     md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Dipp',             'Eduardo',     200879489, 'id24@gmail.com', 5,           0), /* 24 */
(3,      'hugo',        'hugo',        md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Alconz',           'Hugo',        200904390, 'id25@gmail.com', 2,           0), /* 25 */
(2,      'alexey',      'alexey',      md5('asdf'), UNIX_TIMESTAMP(), 'inactive', 'Rodriguez',        'Alexey',      200982298, 'id26@gmail.com', 1,           0), /* 26 */
(2,      'aquilino',    'aquilino',    md5('asdf'), UNIX_TIMESTAMP(), 'active',   'Davalos',          'Aquilino',    200873187, 'id27@gmail.com', 0,           0); /* 27 */
...
(`author`, `recipient`,    `tsregister`)
VALUES
( 1,       'global',       1249974159),	     /* NOTE   1 AVISE */
( 2,       'area-1',       1249974160),	     /* NOTE   2 */
( 2,       'subject-8',    1249974161),		 /* EVENT  3 */
( 3,       'subject-11',   1249974162),		 /* FILE   4 */
( 4,       'group-12',     1249974163),		 /* NOTE   5 AVISE */
( 4,       'group-12',     1249974164),		 /* NOTE   6 */
( 8,       'group-16',     1249974165),		 /* FILE   7 */
(10,       'subject-7',    1249974166),	     /* NOTE   8 */
(11,       'global',       1249974167),		 /* NOTE   9 AVISE */
(11,       'global',       1249974168),		 /* FILE  10 */
(11,       'global',       1249974169),		 /* EVENT 11 */
(14,       'subject-12',   1249974170),	     /* NOTE  12 */
(15,       'global',       1249974171),		 /* NOTE  13 */
(16,       'subject-7',    1249974172),	     /* NOTE  14 AVISE */
(16,       'subject-11',   1249974173),		 /* EVENT 15 */
(17,       'global',       1249974174),		 /* FILE  16 */
(18,       'team-1',       1249974175),		 /* EVENT 17 */
(19,       'team-2',       1249974176),	     /* NOTE  18 */
(20,       'global',       1249974177),		 /* EVENT 19 */
(21,       'user-22',      1249974178),		 /* NOTE  20 */
(21,       'user-23',      1249974179),		 /* NOTE  21 */
(22,       'user-21',      1249974180),	     /* NOTE  22 */
(23,       'user-24',      1249974181),		 /* NOTE  23 */
(24,       'user-22',      1249974182),	     /* NOTE  24 */
(24,       'global',       1249974183),		 /* EVENT 25 */
(25,       'global',       1249974184),		 /* FILE  26 */
(26,       'area-1',       1249974185),	     /* NOTE  27 */
(15,       'community-1',  1249974186),		 /* NOTE  28 */
(23,       'community-1',  1249974187);		 /* EVENT 29 */
