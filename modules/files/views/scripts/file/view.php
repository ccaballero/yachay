...
<table width="100%">
    ...
    <tr valign="top">
        ...
        <?php if (Yeah_Acl::hasPermission('ratings', 'new')) { ?>
            <a href="<?= $this->url(array('resource' => $this->resource->ident), 'files_file_rating_down') ?>"><b>&laquo;</b></a>
        <?php } ?>
                <i><?= $this->resource->ratings ?> / <?= $this->resource->raters ?></i>
        <?php if (Yeah_Acl::hasPermission('ratings', 'new')) { ?>
            <a href="<?= $this->url(array('resource' => $this->resource->ident), 'files_file_rating_up') ?>"><b>&raquo;</b></a>
        <?php } ?>
        </td>
    </tr>
    <tr valign="top">
