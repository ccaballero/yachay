...
if (count($this->friends)) {
    ...
    foreach ($this->friends as $friend) {
        $user = $this->model_users->findByIdent($friend->friend);
        ...
        echo '<td colspan="2"><b>Fecha de contacto: </b>' . $this->timestamp($friend->tsregister) . '</td></tr>';
    }

    echo '</table>';
} else {
    echo '<p>No existen amigos registrados</p>';
}
