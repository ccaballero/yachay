...
<form method="post" action="" accept-charset="utf-8">
    ...
    <p><label for="invitation_email">Correo electronico (*): </label><input id="invitation_email" name="email" type="text" value="<?= $this->invitation->email ?>" size="64" maxlength="64" /></p>
