...
<form method="post" action="" accept-charset="utf-8">
    ...
    <p><label for="note_publish">Publicar en (*): </label><?= $this->context('publish') ?></p>
    ...
    <p class="submit"><input type="submit" value="Crear nota" /><input type="button" value="Cancelar" onclick="location.href='<?= $this->lastPage() ?>'" /></p>
</form>
