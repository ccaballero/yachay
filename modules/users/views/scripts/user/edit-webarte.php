<h1>Editar usuario: <?= $this->user->label ?></h1>
...
<?php } ?>
    ...
    <p class="submit"><input type="submit" value="Actualizar usuario" /><input type="button" value="Cancelar" onclick="location.href='<?= $this->lastPage() ?>'" /></p>
</form>
