...
<form method="post" action="" enctype="multipart/form-data" accept-charset="utf-8">
    ...
    <p><label for="community_label">Nombre de comunidad (*): </label><input id="community_label" name="label" type="text" value="<?= $this->community->label ?>" maxlength="20" /></p>
    ...
    <p><label for="community_tags">Etiquetas (**): </label><input id="community_tags" name="tags" type="text" value="<?= $this->tags ?>" maxlength="128" /></p>
