...
<form method="post" action="" accept-charset="utf-8">
    ...
    <p><label>Formula (*): </label><input type="text" name="formula" size="15" maxlength="300" value="<?= $this->formula ?>" /></p>
    <p>(*) Campos obligatorios.</p>
    <p class="submit"><input type="submit" value="Evaluar" /><input type="button" value="Cancelar" onclick="location.href='<?= $this->lastPage() ?>'" /></p>
</form>

<br />
<p class="message"><span class="bold">Resultado: </span><?= $this->result ?></p>
